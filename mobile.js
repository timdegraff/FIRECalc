    ...
    'assumptions': () => `
        <div class="space-y-4">
            ...
            <div id="mobile-assumptions-summary" class="pt-4 border-t border-slate-800 space-y-2">
                <button id="btn-reset-defaults-mobile" class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-[9px] font-black text-slate-400 uppercase tracking-widest active:scale-95 active:bg-slate-700 transition-all">
...
const ITEM_TEMPLATES = {
    ...
    stockOption: (data) => {
       ...
       <div class="mobile-card space-y-1.5">
           <div class="flex justify-between items-center"><input data-id="name" value="${data.name || ''}" class="bg-transparent font-black text-white uppercase tracking-widest text-[10px] w-2/3 outline-none" placeholder="Grant"><div class="text-[10px] font-black text-teal-400 mono-numbers">${math.toCurrency(equity)}</div></div>
